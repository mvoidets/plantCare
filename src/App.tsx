...
const plantGuide = [
  ...
  { id: 3, name: "Climbing Aloe", description: "Climbing aloe: Living room and bedroom", image: "/images/aloe2.JPG", careGuide: "Water every 2 weeks, soil needs to be dry between watering" },
